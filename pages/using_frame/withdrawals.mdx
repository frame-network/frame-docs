...
The full withdrawal process using the native bridge takes about 8 days.
Once a withdrawal is initiated on Frame, an 8 day dispute window is opened to allow honest parties to challenge the validity of the withdrawal.
...
They then promptly send ETH to the user and later claim the bridged ETH following the challenge window (~8 days).
