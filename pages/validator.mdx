...
```bash
docker run --rm -it -v <ABSOLUTE_PATH>/node-data:/home/user/.frame -v <ABSOLUTE_PATH>/node-config/testnet.json:/home/user/testnet.json public.ecr.aws/o8e2k8j7/nitro-node:frame --conf.file testnet.json
```
